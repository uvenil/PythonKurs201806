class Kalender(object):
    tageProMonat = (None, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)# Tupel
    ...
    def naechsterTag(self):
        ...
        if self.tag > Kalender.tageProMonat[self.monat] + korrektur: # TODO: nicht alle Monate haben 31 Tage
            self.tag = 1
            self.monat += 1
            if self.monat > 12:
                self.monat = 1
