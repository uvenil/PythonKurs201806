class Kalender(object):
    tageProMonat = (None,31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)# none als Platzhalter damit 32 index 1 hat wie Januar
    ...
    def naechsterTag(self):
        ...
        if self.tag >k.tageProMonat[self.monat] + korrektur:
            self.tag = 1
            self.monat += 1
            if self.monat > 12:
                self.monat = 1
...
k =Kalender(27, 1, 2000)

if __name__ == '__main__': # damit Code nicht bei import ausgeführt wird
